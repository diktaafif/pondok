			...
			<div class="container">
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						<li class="active"><a href="<?=site_url()?>/pegawai/read"><i class="glyphicon glyphicon-home"></i>Data Pegawai</a></li>
						<li><a href="create"><i class="glyphicon glyphicon-info-sign"></i>Tambah Data</a></li>
